...
'Get infos about "Python constructor" company': 'Get infos about "Python constructor" company',
'Get infos about first company': 'Get infos about first company',
'Get infos about the first employee at first company': 'Get infos about the first employee at first company',
'Get the first employee at first company': 'Get the first employee at first company',
'Group ID': 'Groupe ID',
'Groups': 'Groupes',
...
'List all employees at "Python constructor"': 'List all employees at "Python constructor"',
'List all employees at first company': 'List all employees at first company',
...
'Or try your own request to %s': 'Or try your own request to %s',
'Origin': 'Origine',
...
'Please call api controller': 'Please call api controller',
'Plugins': 'Plugins',
...
'Search company where name contains "ython"': 'Search company where name contains "ython"',
'Search company where name starts with "Py"': 'Search company where name starts with "Py"',
'Search first company': 'Search first company',
'Search one company where name contains "ython"': 'Search one company where name contains "ython"',
'Search one employee where name contains ""er""': 'Search one employee where name contains ""er""',
'Semantic': 'Sémantique',
'Services': 'Services',
...
'Try your own request to %s': 'Try your own request to %s',
'Twitter': 'Twitter',
